...
if(isset($_POST['update'])){
    ...
    $update_customer = "update customers set customer_name='$c_name',customer_email='$c_email',custmer_country='$c_country',customer_city='$c_city',customer_address='$c_address',customer_contact='$c_contact',customer_image='$c_image' where customer_id='$update_id' ";
...
<div class="container">
    <div class="row justify-content-center">
        ...
        <input type="text" name="c_contact" class="form-control" maxlength="11" required value="<?php echo $customer_contact; ?>">
        ...
        <input type="file" name="c_image" class="form-control form-height-custom" required value="<?php echo $customer_image; ?>">
        
            </div>
            <div class="text-center">
                <button name="update" class="btn btn-outline-dark mt-4 px-5" onclick="return check()" >
