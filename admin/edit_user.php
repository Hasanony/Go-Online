...
<div class="row"><!-- row Begin -->
    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <div class="panel panel-defaultt"><!-- panel panel-default Begin -->
  ...
  <div class="row">
    ...
    <div class="form-group col-md-6">
     ...
     <div class="col-md-12"><!-- col-md-6 Begin -->
                        <label for="inputZip" id="required">Profile Picture</label>    
     <input name="a_img" type="file" class="form-control form-height-custom" required>
                          
         <br>
                          
         <img width="70" height="70" src="images/<?php echo $a_img; ?>">
