...
<body>
 ...
 <div class="row"><!-- row no: 1 begin -->
    <div class="col-lg-12"><!-- col-lg-12 begin -->
        <h1 class="page-header">Add Staffs </h1>
    ...
    <div class="col-lg-12"><!-- col-lg-12 Begin -->
        ...
        <ol class="breadcrumb"><!-- breadcrumb Begin -->
            ...
            <li class="active"><!-- breadcrumb Begin -->
                ...
                <i class="fa fa-dashboard"></i> Dashboard /Add Staffs
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel-heading Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                   ...
                   <i class="fa-solid fa-users-line"></i> Add Staffs
               ...
               <div class="form-group"><!-- form-group Begin -->
                    ...
                    <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="c_type" type="text" class="form-control" placeholder="employee" value="employee" readonly>
