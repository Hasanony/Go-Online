...
<?php 
    ...
    if(isset($_GET['edit_p_cat'])){
        ...
        $get_p = "select * from product_catagories where p_cat_id='$edit_id'";
        
        $run_edit = mysqli_query($con,$get_p);
        if($run_edit && mysqli_num_rows($run_edit) > 0) {
        $row_edit = mysqli_fetch_array($run_edit);
        
        $s_id = $row_edit['p_cat_id'];
        
        $s_title = $row_edit['p_cat_title'];
        $s_desc = $row_edit['p_cat_desc'];
        
       $s_image = $row_edit['p_c_img'];
        }else{
            $s_id='default';
            $s_title='default';
            $s_image='default';
        ...
        <div class="panel panel-default"><!-- panel panel-default Begin -->
           ...
           <div class="panel-heading"><!-- panel panel-default Begin -->
               ...
               <h3 class="panel-title"><!-- panel-title Begin -->
                  ...
                  <i class="fas fa-wrench"></i>&nbsp; Update Product Category
           ...
           <div class="panel-body"><!-- panel-body Begin -->
            ...
            <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="category_images/<?php echo $s_image; ?>" alt="<?php echo $s_image; ?>">
...
if(isset($_POST['update'])){
    ...
    move_uploaded_file($temp_name1, "category_images/$s_img");
    
    $update_ad = "UPDATE product_catagories SET p_cat_title ='$s_title', p_c_img='$s_img',p_cat_desc='$s_desc' WHERE p_cat_id='$edit_id'";
    
    $run_product = mysqli_query($con, $update_ad);
    
    if($run_product){
        echo "<script>alert('Your Product_category has been updated Successfully')</script>"; 
